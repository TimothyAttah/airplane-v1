    ...
    <Styles.HomeAircraftContainer>
      ...
      <Styles.HomeAircraftWrapper>
        <FadeIn delay={0.4} direction='right' fullWidth>
          <Styles.HomeAircraftTitle>2019 Citation M2</Styles.HomeAircraftTitle>
        </FadeIn>
        <FadeIn delay={0.4} direction='left' fullWidth>
          <Styles.HomeAircraftPrice>$275,000</Styles.HomeAircraftPrice>
        </FadeIn>
...
export default HomeAircraftOne;
