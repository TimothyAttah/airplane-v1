    ...
    <Styles.HomeAircraftContainer>
      ...
      <Styles.HomeAircraftWrapper>
        <FadeIn delay={0.4} direction='right' fullWidth>
          <Styles.HomeAircraftTitle>2009 Learjet 60XR</Styles.HomeAircraftTitle>
        </FadeIn>
        <FadeIn delay={0.4} direction='left' fullWidth>
          <Styles.HomeAircraftPrice>$31,000,000</Styles.HomeAircraftPrice>
        </FadeIn>
...
export default HomeAircraftFour;
