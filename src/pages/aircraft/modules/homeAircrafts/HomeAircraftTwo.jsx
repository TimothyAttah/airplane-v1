    ...
    <Styles.HomeAircraftContainer>
      ...
      <Styles.HomeAircraftWrapper>
        <FadeIn delay={0.4} direction='right' fullWidth>
          <Styles.HomeAircraftTitle>1987 Boeing 737</Styles.HomeAircraftTitle>
        </FadeIn>
        <FadeIn delay={0.4} direction='left' fullWidth>
          <Styles.HomeAircraftPrice>$285,000</Styles.HomeAircraftPrice>
        </FadeIn>
...
export default HomeAircraftTwo;
