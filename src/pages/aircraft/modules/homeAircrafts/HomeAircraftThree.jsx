    ...
    <Styles.HomeAircraftContainer>
      ...
      <Styles.HomeAircraftWrapper>
        <FadeIn delay={0.4} direction='right' fullWidth>
          <Styles.HomeAircraftTitle>2007 Citation X</Styles.HomeAircraftTitle>
        </FadeIn>
        <FadeIn delay={0.4} direction='left' fullWidth>
          <Styles.HomeAircraftPrice>$399,000</Styles.HomeAircraftPrice>
        </FadeIn>
...
export default HomeAircraftThree;
